...
*					TX     PA9
*					RX		 PA10
*		115200 0 PANID=0x386F ADDR=0x846C ADDR=0x0000 CHANNEL=11/2405MHz 
...
//	MPU6050_setZAccelOffset(1788);	// value set up only MPU6050 module
	...
	sprintf((char*)buff_char,"AT+GETCFG\r\n");
				...
				if(time_count >=4)
					{
						...
						{
							sprintf((char*)buff_char,"@D 0000000001 NGA_NGUA^\r\n");
							HAL_UART_Transmit(&huart1,buff_char,strlen((char*)buff_char),100);
						}
						if(Loai_nga == NGA_SAP)
						{
							sprintf((char*)buff_char,"@D 0000000001 NGA_SAP^\r\n");
							HAL_UART_Transmit(&huart1,buff_char,strlen((char*)buff_char),100);
						}
						if(Loai_nga == NGA_PHAI)
						{
							sprintf((char*)buff_char,"@D 0000000001 NGA_PHAI^\r\n");
							HAL_UART_Transmit(&huart1,buff_char,strlen((char*)buff_char),100);
						}
						if(Loai_nga == NGA_TRAI)
						{
							sprintf((char*)buff_char,"@D 0000000001 NGA_TRAI^\r\n");
							HAL_UART_Transmit(&huart1,buff_char,strlen((char*)buff_char),100);
						}
